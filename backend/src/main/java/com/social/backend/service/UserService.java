            ...
            try {
                ...
                if (attempts != null && attempts >= 5) {
                    ...
                    emailService.sendEmail(
                        user.getEmail(),
                        "Pacely Account Temporarily Locked",
                        "<div style='font-family:sans-serif;max-width:480px;margin:auto;padding:24px;" +
                        "border-radius:12px;border:1px solid #e5e7eb;'>" +
                        "<h2 style='color:#DC2626;'>&#128274; Account Locked</h2>" +
                        "<p>Hi <strong>" + user.getUsername() + "</strong>,</p>" +
                        "<p>Your Pacely account has been <strong>temporarily locked for 15 minutes</strong> " +
                        ...
                        "<p style='color:#9ca3af;font-size:11px;'>Pacely Security Team</p>" +
                        "</div>"
                    );
                    throw new RuntimeException(
