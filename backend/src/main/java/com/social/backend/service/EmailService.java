...
public class EmailService {
    ...
    private static final String SENDER_NAME    = "Pacely";
    ...
    public String testEmail(String to) {
        ...
        try {
            Map<String, Object> payload = Map.of(
                ...
                "subject",     "Pacely Email Test",
                "htmlContent", "<p>This is a test email from Pacely. If you received this, email is working!</p>"
            );
    ...
    public void sendOtpEmail(String toEmail, String otp) {
        ...
        String html =
            ...
            "<p style='color:#71717a;font-size:14px;margin:0;'>Pacely</p></div>" +
        ...
        sendEmail(toEmail, "Your Pacely Password Reset Code", html);
    }
    ...
    public void sendLoginNotificationEmail(String toEmail, String username) {
        String html =
            ...
            "<p style='color:#3f3f46;'>Your Pacely account was just logged in via Google.</p>" +
            ...
            "<hr style='border:none;border-top:1px solid #f4f4f5;margin:24px 0;'/>" +
            "<p style='color:#a1a1aa;font-size:11px;'>Pacely Security Team</p>" +
            "</div>";

        sendEmail(toEmail, "New Login Detected - Pacely", html);
    }
    ...
    public void sendDeveloperEmail(String developerEmail, String senderUsername,
        ...
        String html =
            ...
            "padding:32px;border-radius:16px;border:1px solid #e5e7eb;background:#fff;'>" +
            "<h2 style='color:#4F46E5;'>&#128233; Pacely Report</h2>" +
            ...
            body.replace("\n", "<br/>") + "</div>" +
            "<hr style='border:none;border-top:1px solid #f4f4f5;margin:24px 0;'/>" +
            "<p style='color:#a1a1aa;font-size:11px;'>Pacely &mdash; Auto-generated report</p>" +
            "</div>";

        sendEmail(developerEmail, "[Pacely] " + subject, html);
    }
}
