...
public class EmailService {
    ...
    private static final String SENDER_NAME    = "Vibely";
    ...
    public String testEmail(String to) {
        ...
        try {
            Map<String, Object> payload = Map.of(
                ...
                "subject",     "Vibely Email Test",
                "htmlContent", "<p>This is a test email from Vibely. If you received this, email is working!</p>"
            );
    ...
    public void sendOtpEmail(String toEmail, String otp) {
        ...
        String html =
            ...
            "<p style='color:#71717a;font-size:14px;margin:0;'>Vibely</p></div>" +
        ...
        sendEmail(toEmail, "Your Vibely Password Reset Code", html);
    }
    ...
    public void sendLoginNotificationEmail(String toEmail, String username) {
        String html =
            ...
            "<p style='color:#3f3f46;'>Your Vibely account was just logged in via Google.</p>" +
            ...
            "<hr style='border:none;border-top:1px solid #f4f4f5;margin:24px 0;'/>" +
            "<p style='color:#a1a1aa;font-size:11px;'>Vibely Security Team</p>" +
            "</div>";

        sendEmail(toEmail, "New Login Detected - Vibely", html);
    }
    ...
    public void sendDeveloperEmail(String developerEmail, String senderUsername,
        ...
        String html =
            ...
            "padding:32px;border-radius:16px;border:1px solid #e5e7eb;background:#fff;'>" +
            "<h2 style='color:#4F46E5;'>&#128233; Vibely Report</h2>" +
            ...
            body.replace("\n", "<br/>") + "</div>" +
            "<hr style='border:none;border-top:1px solid #f4f4f5;margin:24px 0;'/>" +
            "<p style='color:#a1a1aa;font-size:11px;'>Vibely &mdash; Auto-generated report</p>" +
            "</div>";

        sendEmail(developerEmail, "[Vibely] " + subject, html);
    }
}
