...
export default function SettingsPage() {
  ...
  const handleDeleteAccount = () => {
    setConfirmModal({
      ...
      desc: 'Are you absolutely sure you want to delete your account? This action cannot be undone.',
      onConfirm: async () => {
        try {
  ...
  const renderMore = () => (
    <div className="space-y-8 max-w-2xl">
      ...
      <div className="border-t border-zinc-100 dark:border-zinc-800 pt-6">
        ...
        <p className="text-xs text-zinc-400 dark:text-zinc-500 mb-3">For any queries, reach out to us at support@relay.social</p>
      </div>
    </div>
  );
